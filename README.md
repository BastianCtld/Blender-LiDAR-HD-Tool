...
- There is a small height difference between the exported and the gpu-side point cloud. The difference is consistent across one loaded set of tiles, but differs set to set. I'm not sure why this happens
