...
- There is a small height difference between the exported point cloud and the gpu-side. The difference is consistent across one loaded set of tiles, but differs set to set. I'm not sure why this happens
